...
public class ActivityVideoDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bannerAdView.setAdUnitId("R-M-1589103-1");
        ...
        loader.loadAd(new NativeAdRequestConfiguration.Builder("R-M-1589103-2").build());

        InterstitialAd interstitialAd = new InterstitialAd(this);
        interstitialAd.setAdUnitId("R-M-1589103-3");
